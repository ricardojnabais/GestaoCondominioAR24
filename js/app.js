...
import * as adminManutencao from './ui/admin/manutencao.js';
...
async function main() {
  console.log('[app] Gestão do Condomínio AR24 · v2.9 · produção');
  ...
  router.register('admin/manutencao',       adminManutencao,      { requiresAuth: 'admin' });
